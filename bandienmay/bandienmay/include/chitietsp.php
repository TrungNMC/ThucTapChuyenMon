    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 single-right-left simpleCart_shelfItem">
                <h3 class="mb-3"><?php echo $row_chitiet['sanpham_name'] ?><a class="btn btn-primary" style="color: red;background: pink;margin-left: 15px;" href="#"><i class="fa fa-heart"></i></a></h3>
                ...
                <br>
                <div class="icon" style="float: right; font-size: 24px; color: #ccc;">
                <ul>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fab fa-facebook"></i></li>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fab fa-twitter-square"></i></li>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fab fa-linkedin"></i></li>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fas fa-rss-square"></i></li>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fab fa-pinterest"></i></li>
                <li style="display: inline-block;padding-right: 15px;padding-left: 5px;"><i class="fas fa-link"></i></li>
                </ul>
                </div>
            </div>
        </div>
