...
<?php
 if(isset($_POST['themgiohang'])){
 	...
 	if($sql_khachhang){
 		...
 		for($i=0;$i<count($_POST['thanhtoan_product_id']);$i++){
	 		...
	 		$sql_donhang = mysqli_query($con,"INSERT INTO tbl_donhang(khachhang_id,mahang) values ('$khachhang_id','$mahang')");
			...
			$sql_ctdh = mysqli_query($con,"INSERT INTO tbl_ctdh(sanpham_id,mahang,soluong) values ('$sanpham_id','$mahang','$soluong')");
 ...
 if(isset($_POST['thanhtoandangnhap'])){
 	...
 	for($i=0;$i<count($_POST['thanhtoan_product_id']);$i++){
		 ...
		 echo '<script>window.location.href = "http://localhost:8080/bandienmay/include/thanhtoan.php";</script>';
 }
?>
				...
				<div class="table-responsive">
					...
					<table class="timetable_sub">
						...
						?>
							...
							?>
							<tr>
								<td colspan="7">Tổng tiền : <?php echo number_format($_SESSION['tp'] ="$total").' vnđ'?></td>
								<?php $_SESSION['a'] = $_SESSION['tp']; ?>
							</tr>
							<tr>
