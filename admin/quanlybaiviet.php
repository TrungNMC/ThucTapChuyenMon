      ...
      <h4>Liệt kê bài viết</h4>
        ...
        <?php
					...
					<tr>
						...
						<td><img src="../uploads/<?php echo $row_bv['baiviet_image'] ?>" height="auto" width="100"></td>

						<td><?php echo $row_bv['tendanhmuc'] ?></td>
						
						<td><a href="?xoa=<?php echo $row_bv['baiviet_id'] ?>">Xóa</a> || <a href="quanlybaiviet.php?quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>">Cập nhật</a></td>
					</tr>
				<?php
					} 
					?> 
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h4 class="m-0 font-weight-bold text-primary">Danh mục bài viết</h4>
    <div class="card-body">
    <?php
